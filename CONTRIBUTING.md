...
Parchley is a free and open-source project. Changes should keep the app
local-first, sandbox-friendly, and compatible with macOS 26 and Swift 6.

## Before opening a change

- Keep user-visible behavior and error messages clear and recoverable.
- Do not commit downloaded native runtimes, app bundles, credentials, or private
  documents. The pinned OCR model files shipped with Parchley are tracked.
