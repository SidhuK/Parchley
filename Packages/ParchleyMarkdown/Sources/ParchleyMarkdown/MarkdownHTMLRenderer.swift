...
private struct Renderer {
    func render(_ markup: Markup) -> String {
        ...
        if markup is Image { return "<span>[image]</span>" }
        ...
        if let list = markup as? OrderedList { return listHTML(list, ordered: true) }
    ...
    private func escapeAttribute(_ value: String) -> String { escape(value).replacingOccurrences(of: "\n", with: "") }
}
